               ...
               <div class="content" style="margin-bottom:20px;">
                  ...
                  <p class="Location">
                     ...
                     <a href="#"
                        ...
                        class="btn_nav bold">개발자목록</span> <a href="../dashboard/dashboard.do"
                  ...
                  <p style="margin-bottom: 1%;">
                    ...
                    <select id="sklsel" name="sklsel">   </select>
                  ...
                  <p class="conTitle" style="margin-bottom: 1%;">
                     <span>개발자 목록</span> <span class="fr"> 
                     </span>
                  </p>
